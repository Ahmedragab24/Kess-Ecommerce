...
<body>
    ...
    <div class="card-container">
        ...
        <div class="categories">
            ...
            <form action="" method="POST">
                ...
                <select name="categories[]" id="categories" class="custom-select" multiple>
                    ...
                    $sql1 = "SELECT * FROM `categories` WHERE is_store_parent = 1 and is_freelance = 0";
                    ...
                    if ($result1) {
                        ...
                        while ($row1 = mysqli_fetch_assoc($result1)) {
                            ...
                            $selected = (in_array($row1['id'], $selectedCategories)) ? 'selected' : ''; // Check if category is associated with the current store
        ...
        <div class="card">
            ...
            <img src="../../media/storePhotes/<?php echo $row1['Photo'] ?? "Logo (NO TEXT).png"; ?>" alt="">
            ...
            <div class="card-content">
                ...
                <p>
                    ...
                    <?php echo $row1['Real_store_name'] ?? "No Data"; ?>

                </p>

                <p>

                    <?php echo $row1['Commercial_Activity'] ?? "No Data"; ?>
