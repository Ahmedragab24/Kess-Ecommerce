...
function WomenAccessories() {
  const [womenAccessories, setWomenAccessories] = useState<Store[]>([]);
  ...
  useEffect(() => {
    try {
      ...
      axios
        ...
        .then((res) => setWomenAccessories(res.data.msg));
  ...
  // rendering
  const storeList = womenAccessories.map((store) => {
    return (
  ...
  return (
    <section className="stores">
      <div className="title-container">
        <h1 className="store-title">Women's Accessories</h1>
