...
function About() {
    ...
    useEffect(() => {
        ...
        sr.reveal(`.line , .text-secondary`, { delay: 600 });
    ...
    return (
        <main className="AboutUs">
                            ...
                            <div className="menu-card hover:card">
                                ...
                                <div>
                                    ...
                                    <p className="card-text label-1">
                                        A reputable real estate construction
                                        company brings extensive expertise and
                                        experience to the table. With a solid
                                        track record and professional
                                        background, they are capable of
                                        executing diverse and high-quality real
                                        estate projects.
                                    </p>
                                </div>
                            </div>
                        ...
                        <li>
                            <div className="menu-card hover:card">
                                ...
                                <div>
                                    ...
                                    <p className="card-text label-1">
                                        The company emphasizes meticulous and
                                        comprehensive planning for its real
                                        estate projects. This involves market
                                        analysis, understanding trends, and
                                        potential customer requirements. It also
                                        includes identifying ideal project
                                        locations and designing innovative
                                        residential and commercial unit layouts.
                                    </p>
                                </div>
                            </div>
                        </li>
                        ...
                        <li>
                            <div className="menu-card hover:card">
                                ...
                                <div>
                                    ...
                                    <p className="card-text label-1">
                                        A reliable real estate construction
                                        company focuses on maintaining high
                                        standards of construction and finishes.
                                        They prioritize using top-quality
                                        building materials and work with
                                        experienced contractors and technicians
                                        to ensure projects are built to the
                                        highest standards.
                                    </p>
                                </div>
                            </div>
                        ...
                        <li>
                            <div className="menu-card hover:card">
                                ...
                                <div>
                                    ...
                                    <p className="card-text label-1">
                                        The company values innovative and
                                        architecturally appealing designs that
                                        align with market demands and customer
                                        expectations. They strive to deliver
                                        unique and distinctive projects that
                                        stand out in terms of design and
                        ...
                        <li>
                            <div className="menu-card hover:card">
                                ...
                                <div>
                                    ...
                                    <p className="card-text label-1">
                                        Attention to detail is paramount in all
                                        projects undertaken by the company. They
                                        place great importance on executing
                                        precise finishes and equipping projects
                                        with all necessary facilities and
                                        services to ensure customer comfort and
                                        satisfaction.
                                    </p>
                                </div>
                            </div>
                        ...
                        <li>
                            <div className="menu-card hover:card">
                                ...
                                <div>
                                    ...
                                    <p className="card-text label-1">
                                        A reliable real estate construction
                                        company is committed to meeting project
                                        timelines. They prioritize delivering
                                        projects on schedule according to the
                                        agreed-upon commitments with customers.
                                    </p>
                                </div>
                            </div>
                        </li>
                    ...
                    <div className="special-dish-content">
                        <div className="container">
                            ...
                            <p className="section-text">
                                we are curious creatives inspired by human
                                nature and behaviour to create and evolve
                                connections between brands and people.
                                <br />
                                <br />
                                unpopular opinions are simply defined as ideas
                                that go against or completely contradict the
                                conventional status quo. “unpopular” is a
                                relative term, because one's opinion may only be
                                that way because of where they are located in
                                the world.
                                <br />
                                <br />
                                across local and regional markets, the “popular”
                                way of dealing with projects is focusing on
                                financial gain rather than quality and
                                creativity. our values and the love we have for
                                what we do, make us prioritize quality and
                                creativity over everything else, which makes our
                                way the “unpopular” way.
                            </p>
                            <a href="#contact">
                                <Button
                                    variant="outlined"
            ...
            <section className="ourClient-section">
                <div className="container">
                    <div className="row justify-content-md-center">
                        <div className="col-12 col-md-10 col-lg-8 col-xl-7 col-xxl-6">
                            ...
                            <p className="section-subtitle mb-5 text-center">
                                Our clients are our top priority, and we are
                                committed to providing them with the highest
                                level of service.
                            </p>
                        </div>
                    </div>
