...
function TermsOfService() {
  return (
    <main className="container my-5 text-center terms-container">
      <h2 className="terms-title">شروط الاستخدام</h2>
      ...
      <div className="terms-container container terms-body">
        ...
        <div className="card terms-card mb-4">
          <div className="card-body terms-card-body">
            <h2 className="card-title">استخدام الموقع</h2>
            <p className="card-text">
        ...
        <div className="card terms-card mb-4">
          <div className="card-body terms-card-body">
            <h2 className="card-title">حساب المستخدم</h2>
            <p className="card-text">
        ...
        <div className="card terms-card mb-4">
          <div className="card-body terms-card-body">
            <h2 className="card-title">الملكية الفكرية</h2>
            <p className="card-text">
        ...
        <div className="card terms-card mb-4">
          <div className="card-body terms-card-body">
            <h2 className="card-title">الروابط الخارجية</h2>
            <p className="card-text">
        ...
        <div className="card terms-card mb-4">
          <div className="card-body terms-card-body">
            <h2 className="card-title">التعديلات على الشروط</h2>
            <p className="card-text">
