  ...
  return (
    <>
      ...
      <section className="cardLink">
        <h2 className="section-title text-center mb-4">Register with us</h2>
        <p className="description text-center mb-5 w-50 mx-auto">
          Be part of us if you are a store owner and want to display it with us
          to reach a large segment of people, or if you are a freelancer and
          looking for a job.
        </p>
        <div className="container cardLink-container">
          <Link to="/registertionStore">
            <Card
              sx={{
                maxWidth: 400,
          ...
          <Link to="/registertionFreelancer">
            <Card
              sx={{
                maxWidth: 400,
                backgroundColor: "var(--spical-color-2)",
