...
function PrivacyPolicy() {
  return (
    <main className="container my-5 text-center privacy-container">
      <h2 className="privacy-title">سياسة الخصوصية</h2>
      ...
      <div className="privacy-container container privacy-body">
        <div className="card privacy-card mb-4">
          <div className="card-body privacy-card-body">
            <h2 className="card-title">مقدمة</h2>
        ...
        <div className="card privacy-card mb-4">
          <div className="card-body privacy-card-body">
            <h2 className="card-title">جمع المعلومات</h2>
            <p className="card-text">
        ...
        <div className="card privacy-card mb-4">
          <div className="card-body privacy-card-body">
            <h2 className="card-title">استخدام المعلومات</h2>
            <p className="card-text">
        ...
        <div className="card privacy-card mb-4">
          <div className="card-body privacy-card-body">
            <h2 className="card-title">مشاركة المعلومات</h2>
            <p className="card-text">
        ...
        <div className="card privacy-card mb-4">
          <div className="card-body privacy-card-body">
            <h2 className="card-title">أمان المعلومات</h2>
            <p className="card-text">
        ...
        <div className="card privacy-card mb-4">
          <div className="card-body privacy-card-body">
            <h2 className="card-title">حقوقك</h2>
            <p className="card-text">
        ...
        <div className="card privacy-card mb-4">
          <div className="card-body privacy-card-body">
            <h2 className="card-title">تغييرات على هذه السياسة</h2>
            <p className="card-text">
        ...
        <div className="card privacy-card mb-4">
          <div className="card-body privacy-card-body">
            <h2 className="card-title">الاتصال بنا</h2>
            <p className="card-text">
