...
import LoginStore from "../pages/registertionStore/LoginStore";
import RegistertionFreelancer from "../pages/registertionFreelacer/RegistertionFreelancer";
import LoginFreelancer from "../pages/registertionFreelacer/LoginFreelancer";
    ...
    createRoutesFromElements(
        <>
            ...
            >
                ...
                <Route
                    path="/registertionStore"
                    element={<RegistertionStore />}
                />
